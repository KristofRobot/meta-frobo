...
SRC_URI += "file://0001-Flite-instead-of-festival.patch"

RRECOMMENDS_${PN} += "roscpp roslib audio-common-msgs diagnostic-msgs gst-plugins-base gst-plugins-ugly gst-plugins-good rospy flite-alsa python-gst gst-meta-audio"
