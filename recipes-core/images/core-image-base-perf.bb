...
IMAGE_INSTALL = "packagegroup-core-boot ${ROOTFS_PKGMANAGE_BOOTSTRAP} ${CORE_IMAGE_EXTRA_INSTALL} xauth xeyes roslaunch rostopic cv-bridge python-opencv rosbag python-numpy rospy wpa-supplicant perf wireless-tools usbutils"
